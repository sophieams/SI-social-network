# Social Network Modeling with a Dynamical Systems Model of SI
A repository for the data and code as part of a project using a theoretical model described in Wang et al. (2023) to include social factors as well. The reference for the original pre-print is found below.
